...
class _DetailState extends State<Detail> {
  ...
  Widget buildSizeButton({title, isSeleted}) {
    return MaterialButton(
      ...
      minWidth: 40,
      elevation: 0,
      color: isSeleted ? Color(0xff181A18) : Color(0xffe8e8e8),
      ...
      child: Center(
        child: Text(
          title,
          style: TextStyle(
            color: isSeleted ? Colors.white : Color(0xff181A18),
          ),
        ),
      ),
      onPressed: () {},
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        CircleAvatar(
                          radius: 15,
                          backgroundColor: Color(0xff181A18),
                        )
                      ],
                    ),
                    Row(
                    ...
                    Column(
                      ...
                      children: [
                        Text(
                          "Black Oversize Hoodie is a pullover",
                          style: TextStyle(
                            fontSize: 15,
                        ...
                        Text(
                          "jacket that suited fit for everyday use.",
                          style: TextStyle(
                            fontSize: 15,
                            color: Color(0xffb2b2b2),
                          ),
